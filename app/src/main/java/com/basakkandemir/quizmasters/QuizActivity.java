...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener((View v)-> {
            ...
            if (selectedOptionByUser.isEmpty()){
                Toast.makeText(QuizActivity.this, "Lütfen bir şık seçiniz.", Toast.LENGTH_SHORT).show();
            }
            else{
                changeNextQuestion();
            }
    ...
    private void changeNextQuestion(){
        ...
        if (currentQuestionPosition < questionsLists.size()){
            ...
            intent.putExtra("doğru", getCorrectAnswers());
            intent.putExtra("yanlış", getIncorrectAnswers());
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if(seconds == 0){
                    ...
                    Toast.makeText(QuizActivity.this, "Süre Doldu", Toast.LENGTH_SHORT).show();
